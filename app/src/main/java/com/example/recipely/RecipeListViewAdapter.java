...
public class RecipeListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.recipe_listview_item, parent, false);
        }
        ...
        // 아이템 내 각 위젯에 데이터 반영
        recipeTxtView.setText(recipeName.toString());
    ...
    public void addItem(String recipeName) {
        listViewItemList.add(recipeName);
    }
